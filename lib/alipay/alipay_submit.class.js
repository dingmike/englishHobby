...
AlipaySubmit.prototype.buildRequestForm = function (para_temp, method, button_name) {
    ...
    sHtml = sHtml + "<input type='button' value=" + button_name + "  onclick='at.frozen.change_zfb_flag();'></form>";
    //
 ...
 * @return 提交表单HTML文本
 */
AlipaySubmit.prototype.buildRequestForm2 = function (para_temp, method, button_name) {
    //待请求参数数组
    var para = this.buildRequestPara(para_temp);
